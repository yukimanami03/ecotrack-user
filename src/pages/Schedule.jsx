        ...
        <div className="reminders-section">
          ...
          <div className="reminders-grid">
            <div className="reminder-item">
              ...
              <p>Place waste outside <strong>before 6:00 AM</strong> on scheduled days.</p>
            </div>
            <div className="reminder-item">
              <FaCheckCircle className="check-icon" />
              <p>Separate <strong>recyclables</strong> (paper, plastic, glass) from general waste.</p>
            </div>
            <div className="reminder-item">
              <FaCheckCircle className="check-icon" />
              <p>Do <strong><span className="underline-text">NOT</span></strong> place batteries or electronics in general bins.</p>
            </div>
            <div className="reminder-item">
              <FaCheckCircle className="check-icon" />
              <p>Ensure all bags are <strong>secured tightly</strong> to prevent spillage.</p>
            </div>
          </div>
        </div>
